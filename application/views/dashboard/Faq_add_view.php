<?php $this->load->viewD("inc/header"); ?>
				...
				<section>
					...
					<div class="row">
					   ...
					   <div class="col-lg-8">
						  <form method="POST" id="frm_fc_faq" name="frm_fc_faq"  enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
								...
								<div class="form-group">
									...
									<textarea cols="5" rows="3" name="txtarea_description" id="txtarea_description" class="form-control" required ></textarea>
								</div>
				</div>
						...
						<div class="clearfix">
							<div class="text-center">
								<span class="help-block m-b-none">* Indicates Required Fields</span>
								 <button type="submit" name="btnAdd" class="btn btn-primary">Add FAQ</button>
