               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     <div class="widget-title">
                        <h4><i class="icon-reorder"></i>Update Pickups / Drops for <?php echo $city; ?></h4>
                     </div>
                     <div class="widget-body form">
                        ...
                        <form id="frm_pickups_drops" name="frm_pickups_drops" method="post" onsubmit="javascript:return val_pickups_drops();" class="form-horizontal" >
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" value="<?php echo $data->pickup_name; ?>" class="span6" id="txt_pickup_name" name="txt_pickup_name" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select class="chosen-with-diselect span6" tabindex="-1" id="dd_pickup_status" name="dd_pickup_status">
										<option value="1" <?php if($data->pickup_status == 1) echo 'selected="selected"'; ?>>Active</option>
										<option value="0" <?php if($data->pickup_status == 0) echo 'selected="selected"'; ?>>Inactive</option>
									</select>
								</div>
							</div>
