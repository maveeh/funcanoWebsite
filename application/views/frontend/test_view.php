...
<!-- Mirrored from www.vasterad.com/themes/listeo_updated/listings-single-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 May 2018 13:00:36 GMT -->
<head>
	...
	<div id="header" class="not-sticky">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index-2.html"><img src="<?php echo FRONTIMG ?>/images/logo.png" alt=""></a>
				</div>
					...
					<ul>
						<li>
							...
							<div class="comment-content"><div class="arrow-comment"></div>
								...
								<div class="review-images mfp-gallery-container">
									<a href="images/review-image-01.jpg" class="mfp-gallery"><img src="<?php echo FRONTIMG ?>/images/review-image-01.jpg" alt=""></a>
								</div>
						...
						<li>
							...
							<div class="comment-content"><div class="arrow-comment"></div>
								...
								<div class="review-images mfp-gallery-container">
									<a href="images/review-image-02.jpg" class="mfp-gallery"><img src="<?php echo FRONTIMG ?>/images/review-image-02.jpg" alt=""></a>
									<a href="images/review-image-03.jpg" class="mfp-gallery"><img src="<?php echo FRONTIMG ?>/images/review-image-03.jpg" alt=""></a>
								</div>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div class="boxed-widget margin-top-35">
				<div class="hosted-by-title">
					...
					<a href="pages-user-profile.html" class="hosted-by-avatar"><img src="<?php echo FRONTIMG ?>/images/dashboard-avatar.jpg" alt=""></a>
				</div>
				<ul class="listing-details-sidebar">
					<li><i class="sl sl-icon-phone"></i> (123) 123-456</li>
					<!-- <li><i class="sl sl-icon-globe"></i> <a href="#">http://example.com</a></li> -->
					<li><i class="fa fa-envelope-o"></i> <a href="#"><span class="__cf_email__" data-cfemail="e2968d8fa2879a838f928e87cc818d8f">[email&#160;protected]</span></a></li>
				</ul>
		...
		<div class="row">
			...
			<div class="col-md-3  col-sm-12">
				...
				<div class="text-widget">
					...
					E-Mail:<span> <a href="#"><span class="__cf_email__" data-cfemail="d2bdb4b4bbb1b792b7aab3bfa2beb7fcb1bdbf">[email&#160;protected]</span></a> </span><br>
				</div>
...
<script src="<?php echo FRONTJS ; ?>/scripts/quantityButtons.js"></script>



<!-- Style Switcher
================================================== -->
<script src="<?php echo FRONTJS ; ?>/scripts/switcher.js"></script>
...
<!-- Mirrored from www.vasterad.com/themes/listeo_updated/listings-single-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 May 2018 13:01:21 GMT -->
</html>