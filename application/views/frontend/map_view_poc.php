...
function geocode($address){
    ...
    $url = "https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyB_cAsPgIRYcg3SfSrtAZkmwITn4gmoHM0";
...
if($_POST){
    ...
    <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyB_cAsPgIRYcg3SfSrtAZkmwITn4gmoHM0"></script>   
