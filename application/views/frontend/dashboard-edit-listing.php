	...
	<div class="dashboard-content">
		...
		<div  class="row">
			...
			<div class="add-listing-section">
						<?php $alreadyUploadedImagesCount = 0; ?>
						<div>
						...
						<div  class="row">
						   ...
						   <div class="col-md-1">
						 	<!-- <div class="review-images mfp-gallery-container"> -->
									<a href="<?php if($flyersData->image!=""){ echo UPLOADPATH."/flyers/".$flyersData->image; $alreadyUploadedImagesCount++; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" class="mfp-gallery"><img src="<?php if($flyersData->image!=""){ echo UPLOADPATH."/flyers/".$flyersData->image; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" alt=""></a>
								<!-- </div> -->
						   </div>

						   <div class="col-md-1">
						 	<!-- <div class="review-images mfp-gallery-container"> -->
									<a href="<?php if($flyersData->image1!=""){ echo UPLOADPATH."/flyers/".$flyersData->image1; $alreadyUploadedImagesCount++; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" class="mfp-gallery"><img src="<?php if($flyersData->image1!=""){ echo UPLOADPATH."/flyers/".$flyersData->image1; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" alt=""></a>
							<!-- </div> -->
						 </div>

						 <div class="col-md-1">
						 	<!-- <div class="review-images mfp-gallery-container"> -->
									<a href="<?php if($flyersData->image2!=""){ echo UPLOADPATH."/flyers/".$flyersData->image2; $alreadyUploadedImagesCount++; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" class="mfp-gallery"><img src="<?php if($flyersData->image2!=""){ echo UPLOADPATH."/flyers/".$flyersData->image2; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" alt=""></a>
								<!-- </div> -->
						 </div>

						 <div class="col-md-1">
						 	<!-- <div class="review-images mfp-gallery-container"> -->
									<a href="<?php if($flyersData->image3!=""){ echo UPLOADPATH."/flyers/".$flyersData->image3; $alreadyUploadedImagesCount++; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" class="mfp-gallery"><img src="<?php if($flyersData->image3!=""){ echo UPLOADPATH."/flyers/".$flyersData->image3; }else{ echo UPLOADPATH."/default-flyer.png" ; } ?>" alt=""></a>
								<!-- </div> -->
						 </div>
				...
				<!-- <form method="post" enctype='multipart/form-data' id="myForm" onsubmit="return dateValidation();" name="login" value="Login"> -->
					...
					<form method="post" id="myForm" enctype='multipart/form-data' onsubmit="return dateValidation();" >
...
<!-- <div>
					...
					<input class="button preview" type="submit" name="btnUpdateFlyers" onclick="dateValidation();" value="Update Flyer">
					</div>
			</form>
...
<script type="text/javascript">
	...
	Dropzone.options.myAwesomeDropzone = {
		maxFilesize:1,
	  maxFiles: <?php echo (4 - $alreadyUploadedImagesCount); ?>,
