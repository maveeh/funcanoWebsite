				...
				<div id="add-listing">
					...
					<div class="col-md-2">
						 	<div class="review-images mfp-gallery-container">
				               ...
				               <!-- <img src="<?php echo UPLOADPATH."/image-icon.png";?>" height="24px" width="24px" data-toggle="modal" data-target="#myModal" onclick="javascript: assignSrc('<?php echo UPLOADPATH."/flyers/".$this->session->userdata(PREFIX.'sessUserId')."/".$flyersData->image ; ?>');" title="View Image"> -->

				                <!--  <img src="<?php echo UPLOADPATH."/image-icon.png";?>" height="24px" width="24px" data-toggle="modal" data-target="#myModal" onclick="javascript: assignSrc('<?php echo UPLOADPATH."/flyers/".$flyersData->image ; ?>');" title="View Image"> -->
...
-->
						...
						<div class="submit-section">
							...
							<div class="row with-forms">
								...
								<div class="col-md-6">
									<h5>End Date</h5>
									 <input type="text" name="endDate" id="booking-date3" data-default-date="<?php echo date('m-d-Y',strtotime($flyersData->endTime)); ?>" data-lang="en" data-format="m-d-Y" data-large-mode="true" data-large-default="true" data-min-year="2017" data-translate-mode="true" data-max-year="2020"> 
				...
				<!-- 	<div class="add-listing-section margin-top-45"> -->
						...
						<div class="submit-section">
							...
							<div class="row with-forms">
								...
								<div class="col-md-6">
									<h5>Country</h5>
									<input value="<?php echo $flyersData->state ; ?>" type="text" name="txt_state" >
								</div>
								<div class="col-md-6">
									<h5>City</h5>
									<select class="chosen-select-no-single" name="sel_city" required>
										<option label="blank" >Select City</option>	
										<option value="New York" <?php if ($flyersData->city=="New York") {
											echo "Selected";
										} ?>>New York</option>
										<option value="Los Angeles" <?php if ($flyersData->city=="Los Angeles") {
											echo "Selected";
										} ?>>Los Angeles</option>
										<option value="Chicago" <?php if ($flyersData->city=="Chicago") {
											echo "Selected";
										} ?>>Chicago</option>
										<option value="Houston" <?php if ($flyersData->city=="Houston") {
											echo "Selected";
										} ?>>Houston</option>
										<option value="Phoenix" <?php if ($flyersData->city=="Phoenix") {
											echo "Selected";
										} ?>>Phoenix</option>
										<option value="San Diego" <?php if ($flyersData->city=="San Diego") {
											echo "Selected";
										} ?>>San Diego</option>
										<option value="Austin" <?php if ($flyersData->city=="Austin") {
											echo "Selected";
										} ?>>Austin</option>
									</select>
								</div>
									...
									<table id="pricing-list-container">
										<tr class="pricing-list-item pattern">
											<td>
												...
												<div class="fm-input pricing-name"><input type="number"  value="<?php echo $flyersData->ticketQuantity ; ?>" name="txt_ticketQuantity" placeholder="Quantity" /></div>
...
<script>$('#booking-date3').dateDropper();</script> 
