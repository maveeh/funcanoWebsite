...
//Get static arrays
if ( ! function_exists('loadStaticArrays')){
	function loadStaticArrays() {
//	echo ABSSTATICPATH."/arrays/static_lookup.php";exit;
		//require_once(ABSSTATICPATH."/arrays/static_lookup.php");
		require(ABSSTATICPATH."/arrays/static_lookup.php");
		$resultArray['userDevice']			=	$userDevice;
		$resultArray['idProofOption']		=	$idProofOption;
		$resultArray['addressProofOption']	=	$addressProofOption;
		$resultArray['days']	=	$days;
		$resultArray['planNature']	=	$planNature;
		return $resultArray;
	}
}
...
function afterStr ($this, $inthat) {
	if (!is_bool(strpos($inthat, $this)))
	return substr($inthat, strpos($inthat,$this)+strlen($this));
}

function afterLastStr ($this, $inthat) {
	if (!is_bool(strrevpos($inthat, $this)))
	return substr($inthat, strrevpos($inthat, $this)+strlen($this));
}

function beforeStr ($this, $inthat) {
	return substr($inthat, 0, strpos($inthat, $this));
}

function beforeLastStr ($this, $inthat) {
	return substr($inthat, 0, strrevpos($inthat, $this));
}

function betweenStr ($this, $that, $inthat) {
	return before ($that, after($this, $inthat));
}

function betweenLastStr ($this, $that, $inthat) {
...
if (!function_exists('unlinkImage')) {
	function unlinkImage($image_name, $folder_name) {
		$image_path = ABSIMGPATH . "/" . $folder_name . "/" . $image_name;
