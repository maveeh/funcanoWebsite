var App = function () {
    ...
    var handleWidgetTools = function () {
			...
			jQuery('.widget .tools .icon-chevron-down, .widget .tools .icon-chevron-up').stop(true,true).live("click",function () {
    ...
    var handleDashboardCharts = function () {
        ...
        var pageviews = global_pageviews;
        var registered = global_registered;
