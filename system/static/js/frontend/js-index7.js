...
jQuery(function() {
"use strict";
	jQuery( "#datepicker,#datepicker2,#datepicker3,#datepicker6,#datepicker7,#datepicker8,#datepicker9,#datepicker10,#datepicker11,#datepicker12,#datepicker13,#datepicker14,#datepicker15,#datepicker16" ).datepicker();
	
	jQuery( "#datepicker4,#datepicker5" ).datepicker({ minDate: 0, maxDate: "+2M" , dateFormat: 'd-M-yy' });
});
